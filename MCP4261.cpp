...
MCP4261::MCP4261(uint8_t slaveSelectPin, float pot0ResistanceRmax, float pot0ResistanceRmin, float pot1ResistanceRmax, float pot1ResistanceRmin)
{
...
void MCP4261::DigitalPotWiperIncrement(bool potNum)
{
...
void MCP4261::DigitalPotWiperDecrement(bool potNum)
{
    byte cmdByte = B00000000;
    ::digitalWrite(_slaveSelectPin, LOW);
    if (potNum)
...
void MCP4261::DigitalPotSetWiperPosition(bool potNum, unsigned int value)
{
    byte cmdByte = B00000000;
...
void MCP4261::DigitalPotSetWiperMin(bool potNum)
{
    if (potNum)
...
void MCP4261::DigitalPotSetWiperMax(bool potNum)
{
    if (potNum)
...
void MCP4261::DigitalPotSetWiperMid(bool potNum)
{
    if (potNum)
...
uint16_t MCP4261::DigitalPotReadWiperPosition(bool potNum)
{
    byte cmdByte = B00000000;
...
uint16_t MCP4261::DigitalPotReadStatusRegister()
{
    byte cmdByte = B00000000;
    byte hByte = B00000000;
    byte lByte = B00000000;
...
uint16_t MCP4261::DigitalPotReadTconRegister()
{
    byte cmdByte = B00000000;
    byte hByte = B00000000;
    byte lByte = B00000000;
...
void MCP4261::DigitalPotWriteTconRegister(uint16_t value)
{
    byte cmdByte = B00000000;
    byte dataByte = B00000000;
    if (value > 255)
...
void MCP4261::DigitalPotStartup(bool potNum)
{
...
void MCP4261::DigitalPotShutdown(bool potNum)
{
    uint16_t tconData = this->DigitalPotReadTconRegister();
    byte hByte = (uint8_t)tconData >> 8;
    byte lByte = (uint8_t)tconData & 0xff;
...
void MCP4261::DigitalPotTerminalBConnect(bool potNum)
{
    uint16_t tconData = this->DigitalPotReadTconRegister();
    byte hByte = (uint8_t)tconData >> 8;
    byte lByte = (uint8_t)tconData & 0xff;
...
void MCP4261::DigitalPotTerminalBDisconnect(bool potNum)
{
    uint16_t tconData = this->DigitalPotReadTconRegister();
    byte hByte = (uint8_t)tconData >> 8;
    byte lByte = (uint8_t)tconData & 0xff;
...
void MCP4261::DigitalPotTerminalAConnect(bool potNum)
{
    uint16_t tconData = this->DigitalPotReadTconRegister();
    byte hByte = (uint8_t)tconData >> 8;
    byte lByte = (uint8_t)tconData & 0xff;
...
void MCP4261::DigitalPotTerminalADisconnect(bool potNum)
{
    uint16_t tconData = this->DigitalPotReadTconRegister();
    byte hByte = (uint8_t)tconData >> 8;
    byte lByte = (uint8_t)tconData & 0xff;
...
void MCP4261::DigitalPotWiperConnect(bool potNum)
{
    uint16_t tconData = this->DigitalPotReadTconRegister();
    byte hByte = (uint8_t)tconData >> 8;
    byte lByte = (uint8_t)tconData & 0xff;
...
void MCP4261::DigitalPotWiperDisconnect(bool potNum)
{
    uint16_t tconData = this->DigitalPotReadTconRegister();
    byte hByte = (uint8_t)tconData >> 8;
    byte lByte = (uint8_t)tconData & 0xff;
...
void MCP4261::DigitalPotInitTcon()
{
    uint16_t tconData = this->DigitalPotReadTconRegister();
    byte hByte = (uint8_t)tconData >> 8;
    byte lByte = (uint8_t)tconData & 0xff;
...
uint16_t MCP4261::DigitalPotResistanceToPosition(bool potNum, float resistance)
{
    if (potNum)
    {
...
float MCP4261::DigitalPotPositionToResistance(bool potNum, uint16_t position)
{
    if (potNum)
    {
